 ...
 */
public class MBaseLink extends BaseDomain implements Serializable {
	...
	private List<MBaseLink> MBaseLinkList;
	...
	public List<MBaseLink> getMBaseLinkList() {
		return MBaseLinkList;
	}

	public void setMBaseLinkList(List<MBaseLink> mBaseLinkList) {
		MBaseLinkList = mBaseLinkList;
	}
