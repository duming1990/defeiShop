 ...
 */
public class CommWelfareDetail extends BaseDomain implements Serializable {

	private static final long serialVersionUID = -1L;

	private Integer id;
	
	private Integer comm_welfare_id;
	...
	public Integer getComm_welfare_id() {
		return comm_welfare_id;
	}

	public void setComm_welfare_id(Integer comm_welfare_id) {
		this.comm_welfare_id = comm_welfare_id;
	}
