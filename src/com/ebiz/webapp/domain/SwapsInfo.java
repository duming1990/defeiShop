 ...
 */
public class SwapsInfo extends BaseDomain implements Serializable {
	...
	private OrderInfo maxorderInfo;

	public OrderInfo getMaxorderInfo() {
		return maxorderInfo;
	}

	public void setMaxorderInfo(OrderInfo maxorderInfo) {
		this.maxorderInfo = maxorderInfo;
	}
