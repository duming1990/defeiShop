...
public class AlipayReturnForMobileAction extends BasePayAction {
	...
	public ActionForward unspecified(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		logger.warn("==verify_result:" + verify_result);
		// verify_result = true;
		...
		String returnUrl = ctx + "/m/MMyHome.do";

		if (order_type.intValue() == Keys.OrderType.ORDER_TYPE_90.getIndex()) {
			returnUrl = ctx + "/m/MActivity.do?method=paySuccess";
		}
