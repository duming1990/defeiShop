...
public class NewsInfoAction extends BaseAdminAction {
	...
	public ActionForward add(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		if (request.getParameter("mod_id").equals("1808003100")) {
			return new ActionForward("/../manager/admin/NewsInfo/news_form.jsp");
		} else {
	...
	public ActionForward edit(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		if (GenericValidator.isLong(id)) {
			...
			newsContent.setId(Integer.valueOf(id));
			newsContent = getFacade().getNewsContentService().getNewsContent(newsContent);
			if (newsContent != null) {
				newsInfo.getMap().put("content", newsContent.getContent());
			}
			...
			// request.setAttribute("newsInfo", true);
			// log.info("=====mod_id===========" + request.getParameter("mod_id"));
			if (request.getParameter("mod_id").equals("1808003100")) {
				return new ActionForward("/../manager/admin/NewsInfo/news_form.jsp");
			} else {
				return mapping.findForward("input");
	...
	public ActionForward fileupload(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		return new ActionForward("/admin/NewsInfo/form_upload.jsp");
	}
