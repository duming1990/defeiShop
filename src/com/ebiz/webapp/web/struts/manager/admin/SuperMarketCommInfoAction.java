...
public class SuperMarketCommInfoAction extends BaseAdminAction {
	@Override
	...
	public ActionForward list(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		for (CommInfo ci : entityList) {
			// 扶贫对象
						...
						commInfoPoors.setComm_id(Integer.valueOf(ci.getId()));
						...
						if (null != commInfoPoorsList && commInfoPoorsList.size() > 0) {
							ci.getMap().put("is_poor_set", "已设置");
							
						}else{
							ci.getMap().put("is_poor_set", "未设置");
						}
