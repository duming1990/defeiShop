...
function importJboxCss() {
	...
	for (var i = 0; i < scripts.length; ++i) {
		...
		if (src) {
			...
			if (index >= 0) {
				index = src.indexOf("jBox");var webRoot = src.substring(0, index);var abcss = document.createElement('link'); abcss.type = 'text/css'; abcss.rel = "stylesheet";abcss.href = webRoot + "jBox/Skins/Gray/jbox.css";head.appendChild(abcss);
				break;
			}
		}
	}
