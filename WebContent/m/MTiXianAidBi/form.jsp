...
<div class="content">
  <html-el:form action="/MTiXianAidBi.do" enctype="multipart/form-data" styleClass="ajaxForm0">
    ...
    <div class="set-site">
      <ul class="formUl">
        <li><span class="grey-name">扶贫金总额：</span>
        <fmt:formatNumber pattern="#0.00" value="${af.map.bi_aid}" var="bi_aid" />
        <html-el:hidden property="bi_aid" value="${af.map.bi_aid}" styleId="bi_aid" />
        <html-el:hidden property="bi_aid_real" value="${af.map.bi_aid}" styleId="bi_aid_real" />
          <span class="price grey-content">${bi_aid}元</span>
        </li>
        ...
        <li style="padding-top: 0">
          <span class="label label-info">扶贫金提现手续费${pre_number}%</span>
        </li>
...
$(document).ready(function() {
	 ...
	 var topBtnUrl = "${ctx}/m/MTiXianAidBi.do?method=list&mod_id=${af.map.mod_id}";
	...
	$("#cash_count").change(function(){
		...
		var bi_aid = parseFloat($("#bi_aid_real").val());
		if (tv > (bi_aid)){
