			...
			if (data.result) {
				...
				window.setTimeout(function () {
					...
					if(null != village_id && "" != village_id){
						location.href="${ctx}/m/MVillageNoCartInfo.do?shipping_address_id=" + data.result+"&village_id="+village_id+"&comm_id="+comm_id+"&comm_tczh_id="+comm_tczh_id + "&isYs=" + isYs+ "&isPt=" + isPt;
					}else{
						location.href="${ctx}/m/MMyCartInfo.do?method=step1&shipping_address_id=" + data.result+"&cart_ids="+cart_ids + "&isYs=" + isYs+ "&isPt=" + isPt;
					}
				}, 1000);
			}
		});
