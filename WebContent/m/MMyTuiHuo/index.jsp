...
<!-- 		<div class="name">我的订单</div> -->
		...
		<a class="name sel" onclick="goUrl('${url}')">虚拟商品订单</a>
		<c:url var="url" value="/m/MMyOrder.do?method=list&order_type=11&mod_id=1100500100" />
		<a class="name sel" onclick="goUrl('${url}')">实物商品订单</a>
