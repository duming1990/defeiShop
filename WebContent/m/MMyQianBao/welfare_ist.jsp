                        ...
                        <ul id="shouru">
	                        <c:forEach var="cur" items="${entityList}" varStatus="vs">
		                        <c:if test="${cur.bi_chu_or_ru eq 1}">
			                        ...
			                        <fmt:formatNumber var="welfare_no" pattern="#0.##" value="${cur.welfare_no}"/>
									<fmt:formatNumber var="welfare_no_before" pattern="#0.##" value="${cur.welfare_no_before}"/>
									<fmt:formatNumber var="welfare_no_after" pattern="#0.##" value="${cur.welfare_no_after}"/>
			                        <li class="${_class}">
			                            <a>
				     						...
				     						<p style="position: absolute;color: green;left:50%;top: 62%;">
				     							+<em>${welfare_no}</em>
				     						</p>
				                            <p style="width: 50%;">
					                            <font>操作前 &nbsp;&nbsp;&nbsp;&nbsp;
						                            <b class="color_y">
						                            	<em>${welfare_no_before}</em> 
						                            </b>元
					                            </font>
				                            </p>
		                        ...
		                        <li class="${_class}">
			                        ...
			                        <p style="width: 50%;">
			                         	<font>操作前 &nbsp;&nbsp;&nbsp;&nbsp;<b class="color_y">
			                         		<em>${welfare_no_before}</em></b>元
			                         	</font>
		                        	</p>
			                        <p style="width: 50%;float: left;">
			                         	<font>操作后&nbsp;&nbsp;&nbsp;&nbsp;<b class="color_y">
			                         		<em>${welfare_no_after}</em></b>元
			                         	</font>
			                        </p>
			                        </a>
		                        </li>
