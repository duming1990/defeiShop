...
<div align="center">
  <html-el:form action="BaseCsAjax.do">
    <html-el:hidden property="method" value="chooseEntpInfoWithHome" />
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="tableClassSearch">
      <tr>
        <th align="left" nowrap="nowrap">
          	商家名称：
          <html-el:text property="entp_name_like" styleClass="webinput" maxlength="50"/>
          &nbsp;
      ...
      <tr>
        <td height="40" align="center"><script type="text/javascript" src="${ctx}/commons/scripts/pager.js">;</script> 
          <script type="text/javascript">
            ...
            pager.addHiddenInputs("method", "chooseEntpInfoWithHome");
...
function returnInfo(val0,val1){
	...
	if(ajax == "selectForBaseLink"){
		W.document.getElementById("entp_ids${af.map.num}").value = val0;
		W.document.getElementById("entp_names${af.map.num}").value = val1;
		W.getEntpLinkInfo(val0,"${af.map.num}");
	}
	api.close();
}
//]]></script>
