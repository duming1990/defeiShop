...
<div align="center">
  <html-el:form action="BaseCsAjax.do">
    <html-el:hidden property="method" value="chooseUserInfo" />
    ...
    <table width="100%" border="0" cellpadding="1" cellspacing="1" class="backTable">
          ...
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr>
              ...
              <td align="center">
               <span class="bgButtonFontAwesome" onclick="returnUserInfo('${cur.id}','${cur.user_name}');">
      ...
      <tr>
        <td height="40" align="center"><script type="text/javascript" src="${ctx}/commons/scripts/pager.js">;</script> 
          <script type="text/javascript">
            ...
            pager.addHiddenInputs("method", "chooseUserInfo");
...
function returnUserInfo(val0,val1){
	...
	W.document.getElementById("person_user_id").value = val0;
	W.document.getElementById("user_name").value = val1;
	api.close();
}
//]]></script>
</body>
