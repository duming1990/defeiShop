...
<div align="center">
  <html-el:form action="BaseCsAjax.do">
    ...
    <html-el:hidden property="is_getTags"/>
    ...
    <table width="100%" border="0" cellpadding="1" cellspacing="1" class="backTable">
          ...
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr>
              ...
              <td align="center">
               <span class="bgButtonFontAwesome" onclick="returnEntpInfo('${cur.id}','${cur.entp_name}','${cur.add_user_name}','${cur.p_index}');">
...
function returnEntpInfo(val0,val1,val2,val3){
	var api = frameElement.api, W = api.opener;
	var is_getTags = "${af.map.is_getTags}";
	...
	if(null != W.document.getElementById("p_index") && null != is_getTags && is_getTags != ''){
		W.document.getElementById("p_index").value = val3;
		W.getTags(val3);
	}
