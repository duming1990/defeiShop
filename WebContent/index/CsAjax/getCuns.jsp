...
<div style="padding: 5px;"></div>
    <table width="100%" border="0" cellpadding="1" cellspacing="1" class="backTable">
          <tr class="tite2">
            <th align="center" nowrap="nowrap">村站名称</th>
            <th align="center" nowrap="nowrap">村站负责人</th>
            <th width="20%" align="center" nowrap="nowrap">操作</th>
          </tr>
          <c:if test="${not empty entityList}">
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr>
              <td align="center">${fn:escapeXml(cur.village_name)} </td>
              <td align="center">${fn:escapeXml(cur.owner_name)} </td>
              <td align="center">
               <span class="bgButtonFontAwesome" onclick="returnUserInfo('${cur.id}','${cur.village_name}');">
      ...
      <tr>
        <td height="40" align="center"><script type="text/javascript" src="${ctx}/commons/scripts/pager.js">;</script> 
          <script type="text/javascript">
            ...
            pager.addHiddenInputs("method", "getCuns");
...
function returnUserInfo(val0,val1){
	...
	W.document.getElementById("cun_id").value = val0;
	W.document.getElementById("tuijian_cun").value = val1;
	api.close();
}
//]]></script>
</body>
