...
<div align="center">
  <html-el:form action="BaseCsAjax.do">
    <html-el:hidden property="method" value="getBrandInfoList" />
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="tableClassSearch">
      <tr>
        <th align="left" nowrap="nowrap">
          	品牌名称：
          <html-el:text property="brand_name_like" styleClass="webinput" maxlength="50"/>
          &nbsp;
  ...
  <table width="100%" border="0" cellpadding="1" cellspacing="1" class="backTable">
          <tr class="tite2">
            <th align="center" nowrap="nowrap">品牌名称</th>
          ...
          <c:forEach var="cur" items="${entityList}" varStatus="vs">
            <tr>
              ...
              <td align="center">
              <span class="bgButtonFontAwesome" onclick="returnInfo('${cur.brand_id}','${cur.brand_name}');">
      ...
      <tr>
        <td height="40" align="center"><script type="text/javascript" src="${ctx}/commons/scripts/pager.js">;</script> 
          <script type="text/javascript">
            ...
            pager.addHiddenInputs("method", "getBrandInfoList");
            pager.addHiddenInputs("brand_name_like", "${fn:escapeXml(af.map.brand_name_like)}");
...
function returnInfo(val0,val1){
	...
	W.document.getElementById("brand_id").value = val0;
	W.document.getElementById("brand_name").value = val1;
	api.close();
}
//]]></script>
