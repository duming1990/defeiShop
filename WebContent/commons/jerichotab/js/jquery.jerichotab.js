...
$.extend($.fn, {
    ...
    buildIFrame: function(src) {
        return this.each(function() {
            ...
            var iframe = $('<iframe id="' + jerichotabiframe + '" name="' + jerichotabiframe + '" src="' + src + '" frameborder="0"  scrolling="yes" />')
    ...
    loadData: function(flag) {
        return this.each(function() {
        	...
        	//$('.jericho_tab .tab_selected').css('color', $('body').css('background-color'));
