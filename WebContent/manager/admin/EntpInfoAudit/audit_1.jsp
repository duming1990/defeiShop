...
<div class="divContent">
  ...
  <html-el:form action="/admin/EntpInfoAudit.do" enctype="multipart/form-data">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableClass">
      <tr>
        <th colspan="4">${type_name}基本信息</th>
      </tr>
      <tr>
      ...
      <tr>
        <td class="title_item">${type_name}简介：</td>
      ...
      <tr>
        <td class="title_item">${type_name}联系人：</td>
      ...
      <c:if test="${not empty af.map.audit_desc_one}">
        <tr>
          ...
          <td nowrap="nowrap" colspan="3"><c:choose>
              ...
              <c:when test="${af.map.audit_state eq -1}"><span class="tip-danger">合伙人审核不通过</span></c:when>
              <c:when test="${af.map.audit_state eq 0}"><span class="tip-default">待审核</span></c:when>
              <c:when test="${af.map.audit_state eq 1}"><span class="tip-success">合伙人审核通过</span>&nbsp;<span class="tip-danger">等待管理员审核</span></c:when>
...
$(document).ready(function(){
	...
	$("a#view_pic1").colorbox({width:"600", height:"600", iframe:false});
	$("a#view_pic2").colorbox({width:"600", height:"600", iframe:false});
	$("a#view_pic3").colorbox({width:"600", height:"600", iframe:false});
	$("a#view_pic4").colorbox({width:"600", height:"600", iframe:false});
	$("a#view_pic5").colorbox({width:"600", height:"600", iframe:false});
	$("a#view_pic6").colorbox({width:"600", height:"600", iframe:false});
	$("a#view_pic7").colorbox({width:"600", height:"600", iframe:false});
	$("a#view_pic8").colorbox({width:"600", height:"600", iframe:false});
	$("a#view_pic9").colorbox({width:"600", height:"600", iframe:false});
	$("a#view_pic10").colorbox({width:"600", height:"600", iframe:false});
