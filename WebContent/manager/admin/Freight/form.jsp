...
<div class="admin divContent" style="margin-bottom:300px">
      <html-el:form action="/admin/Freight.do"  >
        ...
        <html-el:hidden property="own_entp_id" styleId="own_entp_id" value="${af.map.entp_id}"/>  
         ...
         <tr><th colspan="2">模版信息</th></tr>
          ...
          <c:forEach var="index" begin="1" end="1" step="1">
            <tr>
              ...
              <td colspan="2" width="88%">
              <table border="0" cellspacing="0" cellpadding="0" class="tableClass" id="dwtable_${index}">
                  <tr>
                    <td colspan ="6"> 默认费用
