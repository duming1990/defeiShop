    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableClass">
      ...
      <tr>
        ...
        <td colspan="2" width="5%" id="selectImgId">
         <img src="${ctx}/styles/index/images/up_imgs/floor1.png" height="100" class="selectImg" data-flag="1"/>
      	 <img src="${ctx}/styles/index/images/up_imgs/floor2.png" height="100" class="selectImg" data-flag="2"/>
      	 <img src="${ctx}/styles/index/images/up_imgs/floor3.png" height="100" class="selectImg" data-flag="3"/>
      	 <img src="${ctx}/styles/index/images/up_imgs/floor4.png" height="100" class="selectImg" data-flag="4"/>
      	 <img src="${ctx}/styles/index/images/up_imgs/floor5.png" height="100" class="selectImg" data-flag="5"/>
      	 <img src="${ctx}/styles/index/images/up_imgs/floor6.png" height="100" class="selectImg" data-flag="6"/>
        </td>
      </tr>
      </c:if>
