...
<div class="divContent">
  ...
  <html-el:form action="/admin/StoreRanking" styleClass="searchForm">
     ...
     <table width="100%" border="0" cellpadding="1" cellspacing="1" class="tableClassSearch">
      <tr>
        ...
        <div style="margin-top:5px;" id="city_div">
            ...
            &nbsp;&nbsp;&nbsp;总额为0的是否显示：
            <html-el:select property="sum_sale_money" styleId="sum_sale_money">
   ...
   <form id="listForm" name="listForm" method="post">
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableClass">
      <tr class="tite2">
        ...
        <th width="nowrap">所在地区</th>
      </tr>
      <c:forEach var="cur" items="${entityList}" varStatus="vs">
      		<tr align="center">
          <td align="center">${vs.count}</td>
          <td align="center">${cur.entp_name}</td>
          <td align="center">${cur.sale_count}</td>
          <td align="center">${cur.sum_sale_money}</td>
  ...
  <div class="pageClass">
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="StoreRanking.do">
        ...
        <tr>
          <td><script type="text/javascript" src="${ctx}/commons/scripts/pager.js">;</script>
           <script type="text/javascript">
			 ...
			 pager.addHiddenInputs("sum_sale_money","${fn:escapeXml(af.map.sum_sale_money)}");
