...
<div class="divContent">
  ...
  <html-el:form action="/admin/PoorManager" enctype="multipart/form-data">
      ...
      <tr id="trFile">
        ...
        <td colspan="2" width="85%"><div id="divFileHidden" style="display: none;">
          ...
          <div id="divFile">
            ...
            <a href="${ctx}/manager/admin/PoorManager/poor_moban.xls">下载模板</a><br/>
            </div>
   ...
   <table align="center" width="40%" border="0" cellpadding="1" cellspacing="1" class="tableClass">
    ...
    <table align="center" width="40%" border="0" cellpadding="1" cellspacing="1" class="tableClass">
      <tr>
      	<th colspan="4">导入失败的记录</th>
      </tr>
      <tr>
      	<td  width="15%" style="text-align:center;" class="title_item" >Execl序号</td>
      	<td  width="20%" style="text-align:center;" class="title_item" >姓名</td>
      	<td  width="20%" style="text-align:center;" class="title_item" >电话</td>
      	<td  style="text-align:center;" class="title_item" >错误原因</td>
      </tr>
