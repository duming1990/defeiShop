...
<div class="divContent">
  ...
  <html-el:form action="/admin/MoneyWelfareUserQuery.do" enctype="multipart/form-data">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableClass">
      ...
      <tr>
        <td width="15%" class="title_item">凭证图片：</td>
        <td colspan="3"><img src="${ctx}/${af.map.proof_img}" style="width: 300px;"/> </td>
      </tr>
      <tr>
