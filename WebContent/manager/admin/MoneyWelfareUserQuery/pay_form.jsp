...
<div>
  <div>
        <div class="nav_xinping">
          <html-el:form action="/admin/MoneyWelfareUserQuery.do" styleClass="formSaveFhInfo">
	        ...
	        <tr>
	        <td width="12%" nowrap="nowrap" class="title_item" >付款备注：</td>
	        <td width="88%">
	          <html-el:text property="remark" styleId="remark" maxlength="500" style="width:80%;" styleClass="webinput" />
	       	</td>
	        </tr>
	        <tr>
...
$(document).ready(function(){
	...
	$("#btn_submit").click(function(){
		...
		$.ajax({
			type: "POST",
			url: "MoneyWelfareUserQuery.do?method=pay",
			data: $(f).serialize(),
			dataType: "json",
