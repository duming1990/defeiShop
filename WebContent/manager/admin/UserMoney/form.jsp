...
<div class="divContent">
  ...
  <html-el:form action="/admin/UserMoney.do">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableClass">
      ...
      <tr>
        <td width="15%" class="title_item"><span style="color: #F00;">*</span> 会员卡号： </td>
        <td width="85%"><html-el:text property="user_no" maxlength="20" styleClass="webinput" styleId="user_no" style="width:200px" />
          &nbsp;<span id="user_no_tip" style="display:none;"></span></td>
      </tr>
      <tr>
...
$("#btn_submit").click(function(){
	if(Validator.Validate(this.form, 3)){
		...
		var u_no = $.trim($("#user_no").val());
		
		if("" == u_name && "" == mobile && "" == u_no) {
			alert('用户名和密码及会员卡号不能同时为空');
			return false;
		}
		$(":submit").attr("disabled", "disabled");
		$("#tip").remove();
		$.post("UserMoney.do?method=checkUserExist",{user_name : u_name, mobile : mobile, user_no : u_no},function(data){
			if(data == "1"){
