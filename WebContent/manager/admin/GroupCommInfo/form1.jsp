  ...
  <div class="subtitle">
    ...
    <html-el:hidden property="id" />
        ...
        <tr>
            ...
            <td colspan="2" width="88%"><html-el:text property="entp_name" styleId="entp_name" onclick="openEntpChild();"  maxlength="125" style="width:280px" styleClass="webinput" readonly="true"/>
              &nbsp;
      ...
      <tr id="tr_pdType">
          ...
          <td >
          <div>
          <textarea name="comm_tczh_name" id="comm_tczh_name" cols="38" rows="5" readonly="readonly" style="width:300px;">${af.map.sygz_names}</textarea>
           <html-el:hidden property="comm_tczh_id" styleId="comm_tczh_id" />
          &nbsp;
      ...
      <tr>
        ...
        <td colspan="2" width="88%"><html-el:text property="no_dist_price" styleId="no_dist_price" maxlength="10" style="width:120px" styleClass="webinput" readonly="true"/>&nbsp;元</td>
      </tr>
      <tr>
...
function getSygzNames() {
	...
	var sygz_id  =$("#sygz_id").val();
	var sygz_names  =$("#sygz_names").val();
	var url = "${ctx}/BaseCsAjax.do?method=getCommInfoTcList&comm_id="+ comm_id +"&t=" + new Date().getTime();
	$.dialog({
		title:  "选择对应类别",
		width:  770,
		height: 450,
...
function chooseCommInfo(own_entp_id){
	var url = "${ctx}/BaseCsAjax.do?method=chooseCommInfo&ajax=fromGroup&t=" + new Date().getTime();
	$.dialog({
		title:  "选择商品",
		width:  770,
		height: 550,
