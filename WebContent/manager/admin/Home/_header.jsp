  ...
  <div class="J-hub J-banner-newtop ui-slider common-banner common-banner--newtop common-banner--floor log-mod-viewed J-banner-stamp-active mt-slider-content" style="height:60px;">
    <ul class="common-banner__sheets mt-slider-sheet-container">
      <li class="common-banner__sheet cf mt-slider-sheet" style="opacity: 1;">
        ...
        <div class="areas"><a href="${ctx}/manager/admin/BaseLink.do?mod_id=${af.map.mod_id}&link_type=10" class="beautybg">编辑</a></div>
...
<%-- <c:if test="${not empty staticIndex}"> --%>
<!--  <div class="areas"><a style="cursor: pointer;" onclick="genIndexHtml();" class="beautybgFornoColorBox">生成静态页面</a></div>			 -->
<%-- </c:if> --%>
<div class="areas"><a href="${ctx}/manager/admin/BaseLink.do?mod_id=${af.map.mod_id}&link_type=0" class="beautybg">编辑logo</a></div>
  <h1><a class="site-logo">合肥${app_name_min}
  	<img alt="logo" src="${ctx}/styles/index/images/up_imgs/logo1.png" width="170" height="70"></a>
  </h1>
  <div class="city-info">
  ...
  <div class="component-search-box mt-component--booted">
    <div class="J-search-box search-box ">
      ...
      <div class="smart-query-panel" style="display:none">
        ...
        <div class="areas"><a href="${ctx}/manager/admin/BaseLink.do?mod_id=1019002000&link_type=88" class="beautybg">编辑</a></div>
      <div class="J-search-box__hot search-box__hot log-mod-viewed">
        <div class="s-hot"><a class="hot-link  hot-link--first log-acm-viewed">蛋糕</a><a class="hot-link  log-acm-viewed">自助餐</a> <a class="hot-link  log-acm-viewed">烧烤</a> </div>
      </div>
    </div>
  </div>
</div>
<div class="site-mast__site-nav-w forIndexHeader categorys home_categorys">
<div class="site-mast__site-nav">
  <div class="site-mast__site-nav-inner">
    <div class="component-cate-nav mt-component--booted">
    <div class="areas"><a href="${ctx}/manager/admin/BaseLink.do?mod_id=${af.map.mod_id}&link_type=20" class="beautybg">编辑导航</a></div>
    <div class="areas" style="left: 80px;position: absolute;width: 80px;">
    <a class="beautybgFornoColorBox" onclick="refreshCls();">刷新分类</a></div>
    <span class="mt-cates J-nav__trigger">全部分类</span> 
      <!--------主菜单开始---------->
      
      
       <div class="dd cate-nav">
            <div class="cata-nav" id="cata-nav">
            <c:forEach items="${base20LinkList}" var="cur" varStatus="vs">
              <div class="item fore${vs.count}">
                <div class="item-left">
                  <div class="cata-nav-name">
                    <h3><a title="${fn:escapeXml(cur.title)}">${fn:escapeXml(fnx:abbreviate(cur.title, 2 * 12, ""))}</a> </h3>
                  </div>
                  <b>&gt;</b> </div>
              </div>
             </c:forEach>
      ...
      <div>
        <ul class="navbar cf  log-mod-viewed">
      	  <div class="areas"><a href="${ctx}/manager/admin/BaseLink.do?mod_id=${af.map.mod_id}&link_type=3000" class="beautybg">编辑导航</a></div>
