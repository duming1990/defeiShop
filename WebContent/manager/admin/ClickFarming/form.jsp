...
<div class="divContent">
    ...
    <html-el:form action="/admin/ClickFarming" >
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableClass">
            ...
            <tr>
                ...
                <td colspan="2" width="88%">
                    ...
                    <html-el:text property="beginDate" size="10" maxlength="10" readonly="true" onclick="WdatePicker()" value="${_beginDate}"/>
                </td>
            </tr>
            <tr>
...
function openUser(){
    ...
    var url = "ClickFarming.do?method=listUser&user_ids="+user_ids+"&user_names="+user_names;
    $.dialog({
        title:  "选择测试用户",
        width:  1200,
        height: 800,
...
function getdiscount_comm_names(){
    ...
    if(null == own_entp_id || "" == own_entp_id){
        ...
        var url = "ClickFarming.do?method=listCommInfo&own_entp_id="+own_entp_id+"&discount_comm_ids="+discount_comm_ids;
        $.dialog({
            title:  "选择商品",
            width:  1200,
            height:800,
...
function test(discount_comm_ids,comm_type){
    $.ajax({
        type: "POST",
        url: "ClickFarming.do?method=commInfo&discount_comm_ids="+discount_comm_ids+"&comm_type="+comm_type,
        success: function(data){
            ...
            html+='<tr align="center">';
            html+='<td align="left"><c:out value="测试数量："/>';
            html+='<td colspan="2"><input name="count" id="count" maxlength="10" style="width:100px" styleClass="webinput" value="1" onchange="getSum()" datatype="Number" msg="请填写测试数量！"/></td></tr>';
            html+='<tr align="center">';
