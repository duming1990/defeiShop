...
<!--           <td align="left" > -->
<%--           <a style="color:${cur.title_color}; text-decoration:none; <c:if test='${cur.title_is_strong eq 1}'>font-weight:bold;</c:if>" href="${ctx}/indexEntp/IndexNewsInfo.do?method=view&amp;id=${cur.id}" target="blank"> --%>
<%--             <c:out value="${fnx:abbreviate(cur.title, 50, '...')}" /> --%>
<!--             </a> -->
<%--             <a style="color:${cur.title_color}; text-decoration:none; <c:if test='${cur.title_is_strong eq 1}'>font-weight:bold;</c:if>" href="${ctx}/indexEntp/IndexNewsInfo.do?method=view&id=${cur.id}" target="view_window"> --%>
<!--           	  查看 -->
<!--             </a> -->
<!--             </td> -->
