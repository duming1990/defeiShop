  ...
  <div class="subtitle">
   ...
   <div class="all">
      <ul class="nav nav-tabs" id="nav_ul_content">
          <li><a href="${ctx}/manager/admin/UserRelation.do?method=list&user_id=${af.map.user_id}"><span>列表查看</span></a></li>
 ...
 var myChart = echarts.init(document.getElementById(id)); 
	var options = drawEcharts(myChart);
	    $.ajax({
	       type: "post",
	       async: true, //同步执行
	       url: encodeURI("UserRelation.do?method="+ method + "&user_id=${af.map.user_id}"),
