...
<div class="divContent">
  ...
  <div class="tip-danger">
    <h3>【${user_name_par}】的下三级用户:${userSonLevel3Count}个（全部下级：${userSonLevel3Count}个）</h3>
  </div>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" align="left">
            <tr>
              <td width="5%" nowrap="nowrap">
					<div>
					  <html-el:form action="/admin/UserRelation" styleClass="searchForm">
   ...
   <div class="all">
      <ul class="nav nav-tabs" id="nav_ul_content">
          <li class="active"><a href="${ctx}/manager/admin/UserRelation.do?method=list&user_id=${af.map.user_id}"><span>列表查看</span></a></li>
          <li><a href="${ctx}/manager/admin/UserRelation.do?method=lowerlist&user_id=${af.map.user_id}&par_level=1"><span>我的第一级(${recordCount1})</span></a></li>
          <li><a href="${ctx}/manager/admin/UserRelation.do?method=lowerlist&user_id=${af.map.user_id}&par_level=2"><span>我的第二级(${recordCount2})</span></a></li>
          <li><a href="${ctx}/manager/admin/UserRelation.do?method=lowerlist&user_id=${af.map.user_id}&par_level=3"><span>我的第三级(${recordCount3})</span></a></li>
          <li><a href="${ctx}/manager/admin/UserRelation.do?method=listChart&user_id=${af.map.user_id}"><span>图形查看</span></a></li>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableClass">
    ...
    <c:if test="${empty userInfoList}">
      <tr>
        <td colspan="10" align="center"><div class="tip-danger"> 没有下级 </div></td>
      </tr>
    </c:if>
   ...
   <div class="pageClass">
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="UserRelation.do">
