...
<div class="divContent">
  ...
  <html-el:form action="/admin/About.do?method=baseLinkList">
  ...
  <form id="listForm" name="listForm" method="post" action="About.do?method=delete">
    <div style="padding-bottom:5px;">
      ...
      <input type="button" name="add" id="add" class="bgButton" value="添 加" onclick="location.href='About.do?method=add&link_type=${af.map.link_type}';" />
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableClass">
      ...
      <c:forEach var="cur" items="${entityList}" varStatus="vs">
        <tr align="center">
          ...
          <td align="center"><a href="About.do?method=view&id=${cur.id}">点击详情</a></td>
          ...
          <td nowrap="nowrap">
            <a class="butbase" id="edit" onclick="confirmUpdate(null, 'About.do', 'id=${cur.id}&' + $('#bottomPageForm').serialize())"><span class="icon-edit">修改</span></a>
          	<c:if test="${cur.is_del eq 0}">
          	    <a class="butbase" id="remove" onclick="confirmDelete(null, 'About.do', 'id=${cur.id}&' + $('#bottomPageForm').serialize())"><span class="icon-remove">删除</span></a>
            </c:if>
  ...
  <div class="pageClass">
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="About.do?method=baseLinkList">
