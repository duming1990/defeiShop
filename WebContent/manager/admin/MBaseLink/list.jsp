...
<div class="divContent">
  ...
  <html-el:form action="/admin/MBaseLink">
...
<!--           </td> -->
          ...
          <c:if test="${not empty cur.image_path}">
          	<img src="${ctx}/${cur.image_path}" width="200"/>
          </c:if>
          ...
          <td nowrap="nowrap">
         <c:if test="${cur.link_type ne 30}">
            <a class="butbase" id="edit" onclick="confirmUpdate(null, 'MBaseLink.do', 'id=${cur.id}&' + $('#bottomPageForm').serialize())"><span class="icon-edit">修改</span></a>
         </c:if>
           <c:if test="${cur.link_type eq 30}">
            <a class="butbase" id="edit" onclick="confirmUpdate(null, 'MBaseLink.do', 'id=${cur.id}&isNotstyle=true&' + $('#bottomPageForm').serialize())"><span class="icon-edit">修改</span></a>
         </c:if>
          	<c:if test="${cur.is_del eq 0}">
