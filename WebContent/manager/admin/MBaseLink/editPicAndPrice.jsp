...
<!--         <div style="display: none;" id="comm_name_div">商品名称:<span id="comm_name_span" style="color: red;"></span></div> -->
      ...
      <tr>
        ...
        <img src="${img}" height="100" id="image_path_img" style="max-width:300px;" />
        ...
        <div class="files-warp" id="image_path_warp">
          ...
          <c:if test="${(af.map.pre_number eq 1) and (af.map.par_son_type eq 1)}">[图片尺寸] 建议：[700px * 232.84px] </c:if>
          <c:if test="${(af.map.pre_number eq 2) and (af.map.par_son_type eq 1)}">[图片尺寸] 建议：[234.49px * 398.18px] </c:if>
          <c:if test="${(af.map.pre_number eq 2) and (af.map.par_son_type eq 2)}">[图片尺寸] 建议：[465.49px * 207.95px] </c:if>
          <c:if test="${(af.map.pre_number eq 3) and (af.map.par_son_type eq 1)}">[图片尺寸] 建议：[260px * 260px] </c:if>
          <c:if test="${(af.map.pre_number eq 3) and (af.map.par_son_type eq 2)}">[图片尺寸] 建议：[260px * 260px] </c:if>
          <c:if test="${(af.map.pre_number eq 3) and (af.map.par_son_type eq 3)}">[图片尺寸] 建议：[260px * 260px] </c:if>
          <c:if test="${(af.map.pre_number eq 3) and (af.map.par_son_type eq 4)}">[图片尺寸] 建议：[700px * 237.42px] </c:if>
          <c:if test="${(af.map.pre_number eq 4) and (af.map.par_son_type eq 1)}">[图片尺寸] 建议：[464.49px * 271.68px] </c:if>
          <c:if test="${(af.map.pre_number eq 4) and (af.map.par_son_type eq 2)}">[图片尺寸] 建议：[234.49px * 279.57px] </c:if>
          <c:if test="${(af.map.pre_number eq 4) and (af.map.par_son_type eq 3)}">[图片尺寸] 建议：[700px * 236.54px] </c:if>
          <c:if test="${(af.map.pre_number eq 5) and (af.map.par_son_type eq 1)}">[图片尺寸] 建议：[700px * 236.84px] </c:if>
          <c:if test="${(af.map.pre_number eq 5) and (af.map.par_son_type eq 2)}">[图片尺寸] 建议：[233.5px * 260.43px] </c:if>
          <c:if test="${(af.map.pre_number eq 5) and (af.map.par_son_type eq 3)}">[图片尺寸] 建议：[465.49px * 254.69px] </c:if>
          <c:if test="${(af.map.pre_number eq 6) and (af.map.par_son_type eq 1)}">[图片尺寸] 建议：[700px * 271.25px] </c:if>
          <c:if test="${(af.map.pre_number eq 6) and (af.map.par_son_type eq 2)}">[图片尺寸] 建议：[260px * 260px]  </c:if>
          <c:if test="${(af.map.pre_number eq 6) and (af.map.par_son_type eq 3)}">[图片尺寸] 建议：[260px * 260px] </c:if>
          <c:if test="${(af.map.pre_number eq 6) and (af.map.par_son_type eq 4)}">[图片尺寸] 建议：[260px * 260px] </c:if>
          </div>
         </td>
      </tr>
      <tr>
        ...
        <td colspan="2" width="85%">
        <html-el:text property="comm_names" styleId="comm_name" maxlength="125" value ="${af.map.comm_name}" style="width:400px" styleClass="webinput" />
        <html-el:hidden property="comm_ids" styleId="comm_id"  value = "${af.map.comm_id}"/>
