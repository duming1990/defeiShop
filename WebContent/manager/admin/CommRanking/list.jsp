...
<div class="divContent">
  ...
  <html-el:form action="/admin/CommRanking" styleClass="searchForm">
   ...
   <form id="listForm" name="listForm" method="post">
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableClass">
      <tr class="tite2">
        ...
        <th width="nowrap">商店名称</th>
        <th width="nowrap">所属地区</th>
      </tr>
      <c:forEach var="cur" items="${entityList}" varStatus="vs">
      		<tr align="center">
          <td align="center">${vs.count}</td>
          <td align="center">${cur.map.comm_name}</td>
          <td align="center">${cur.map.sum_id}</td>
          <td align="center">${cur.map.sum_good_sum_price}</td>
  ...
  <div class="pageClass">
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="CommRanking.do">
