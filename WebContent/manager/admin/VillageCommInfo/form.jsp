  ...
  <div class="subtitle">
    <h3>${naviString}</h3>
      ...
      <tr>
        ...
        <html-el:text property="comm_name" onblur="validate($('#comm_name').val());" styleId="comm_name" maxlength="128" style="width:280px" styleClass="webinput"/></td>
      </tr>
      <tr>
        <td width="14%" nowrap="nowrap" class="title_item">发布人：</td>
        <td colspan="2" width="88%">${village_dynamic.add_user_name}</td>
      </tr>
      <tr>
        <td width="14%" nowrap="nowrap" class="title_item">发布村：</td>
        <td colspan="2" width="88%">${village_dynamic.village_name}</td>
      </tr>
      <tr>
            	...
            	<c:if test="${empty list_CommTczhPrice}">
                   <tr class="clone_tr">
                      <td align="center" nowrap="nowrap">
                      	<html-el:text property="tczh_name" style="width:300px;" styleId="tczh_name" styleClass="webinput"/>
                      </td>
                      <td align="center">
                      ...
                      <td align="center">
                    	<html-el:text property="tczh_inventory" styleId="tczh_inventory" styleClass="webinput"  size="8" maxlength="8"  onfocus='javascript:setOnlyNum(this);'/>&nbsp;件
                      </td>
                    </tr>
                 </c:if>
                 <c:if test="${not empty list_CommTczhPrice}">
                  <c:forEach var="cur" items="${list_CommTczhPrice}" varStatus="vs" >
                    <tr class="clone_tr">
                      <td align="center" nowrap="nowrap">
                      	<html-el:text property="tczh_name" style="width:300px;" styleId="tczh_name" styleClass="webinput" value="${cur.tczh_name}" />
                      </td>
                      <td align="center">
                      ...
                      <td align="center">
                    	<html-el:text property="tczh_inventory" styleId="tczh_inventory" styleClass="webinput"  size="8" maxlength="8" value="${cur.inventory}" onfocus='javascript:setOnlyNum(this);'/>&nbsp;件
                      </td>
                    </tr>
                  </c:forEach>
                 </c:if>
...
$(document).ready(function(){
	...
	if("1" != $("#is_rebate").val()){
		...
		$("#rebate_scale").attr("dataType", "Range").attr("min", "0").attr("max", "100").attr("require", "true").attr("msg", "请填写正确的返现比例！");
	}
...
// 				</c:if>
  ...
  $("a[id^='del_']").click(function(){
		var obj = $(this);
		$.post("VillageCommInfo.do?method=deleteFile" , {
