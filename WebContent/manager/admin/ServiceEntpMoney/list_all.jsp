...
<%--    <logic-el:match name="popedom" value="+8+"> --%>
  <table width="100%" border="0" cellpadding="1" cellspacing="1" class="tableClassSearch">
    <tr>
      <td width="14%" nowrap="nowrap" class="title_item">
      	返现比充值总额：<fmt:formatNumber var="cz_money_" pattern="#0.########" value="${cz_money/rmb_to_fanxianbi_rate}"/>${cz_money_}
       	返现比派发总额：<fmt:formatNumber var="ps_money_" pattern="#0.########" value="${ps_money/rmb_to_fanxianbi_rate}"/>${ps_money_}
       	返现比剩余总额：<fmt:formatNumber var="sy_money_" pattern="#0.########" value="${sy_money/rmb_to_fanxianbi_rate}"/>${sy_money_}
      </td>
    </tr>
  </table>
<%--   </logic-el:match> --%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableClass">
    ...
    <c:forEach var="cur" items="${userBiRecordlList}" varStatus="vs">
      <tr>
              <td align="center">${fn:escapeXml(cur.add_uname)}</a></td>
        <td align="center">
...
<!--     </tr> -->
  ...
  <div class="black" style="margin-bottom: 100px;">
      ...
      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" >
        <tr>
          <td height="10" ><script type="text/javascript" src="${ctx}/commons/scripts/pager.js">;</script>
            ...
            pager.addHiddenInputs("method", "listAll");
...
<script type="text/javascript">//<![CDATA[
  ...
  $("#download").click(function(){
		...
		var submit = function (v, h, f) {
		    if (v == true) {
		    	location.href = "${ctx}/manager/admin/ServiceEntpMoney.do?method=toExcel&mod_id=${af.map.mod_id}&" + $('.searchForm').serialize();
		    } else {
		    	location.href = "${ctx}/manager/admin/ServiceEntpMoney.do?method=toExcel&code=GBK&mod_id=${af.map.mod_id}&" + $('.searchForm').serialize();
		    }
		    return true;
		};
