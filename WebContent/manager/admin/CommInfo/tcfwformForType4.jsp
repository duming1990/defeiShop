         ...
         <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableClass">
          <tr>
            <td> <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableClass">
                <tr>
                  <th nowrap="nowrap" colspan="5"><b><a class="butbase" onclick="listattr('${af.map.comm_id}')"><span class="icon-configure">规格维护</span></a></b></th>
                </tr>
                <tr>
...
<%--                         <c:set var="cost_price" value="${cur.cost_price}" /> --%>
                    	...
                    	<html-el:text property="orig_price" styleId="orig_price" styleClass="webinput"  size="10" maxlength="10" value="${orig_price}"/>&nbsp;元
<%--                     	<html-el:text property="cost_price" styleId="cost_price" styleClass="webinput"  size="10" maxlength="10" value="${cost_price}"/>&nbsp;元 --%>
         ...
         <tr>
        <td colspan="7" style="text-align:center"><html-el:button property="" value="保 存" styleClass="bgButton" styleId="btn_submit" />
          &nbsp;
...
// 			$("#cost_price", $(this)).attr("datatype", "Currency").attr("msg", "请填写套餐原价格，且必须为数字！").focus(setOnlyNum);
			$("#orig_price", $(this)).attr("datatype", "Currency").attr("msg", "请填写套餐原价格，且必须为数字！").focus(setOnlyNum);
			$("#inventory", $(this)).attr("datatype", "Integer").attr("msg", "请填写套餐库存，且必须为数字！").focus(setOnlyNum);
			$("#buyer_limit_num", $(this)).attr("datatype", "Integer").attr("msg", "请填写套餐库存，且必须为数字！").focus(setOnlyNum);
		}); 
