          ...
          <tr>
            <td> <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableClass">
                ...
                <tr>
                  ...
                  <c:if test="${not empty commInfo and commInfo.comm_type == 20 }">
                  <th nowrap="nowrap">
                  	拼团价格 
                  <div class="batch">
                       <i class="fa fa-edit icon" title="批量修改" onclick="updateAll(this);"></i>
	                     <div class="batch-input" style="display:none;">
		                    ...
		                    <a class="close" onclick="closeUpdateAll(this);">X</a>
		                    <input name="updateAll" type="text" class="text price" style="width:55px;" size="8" maxlength="8"/>
		                    <a class="ncbtn-mini" onclick="setUpdateVal('group_price',this);">设置</a>
	                    </div>
	                  </div>
                  </th>
                  </c:if>
                ...
                <tr class="clone_tr">
                  ...
                  <c:forEach var="cur" items="${list_CommTczhPrice}" varStatus="vs" >
                    <tr class="clone_tr">
                     ...
                     <c:if test="${not empty cur.group_price}">
                     <td align="center">
                    	<html-el:text property="group_price" styleId="group_price"  styleClass="webinput"  size="10" maxlength="10" value="${cur.group_price}" onfocus='javascript:setOnlyNum(this);'/>&nbsp;元
                     </td>
                     </c:if>
                      <td align="center">
			...
			if(ret.code == 1){
				...
				if(null != list && list.length > 0){
					...
					for(var i = 0; i < list.length; i++){
						...
						html += "<td><input type='text' name='comm_weight' id='comm_weight' size='20' maxlength='3'  class='webinput' />&nbsp;%</td>";
						html += "</tr>";
						$("#is_work").val(1);
					}
