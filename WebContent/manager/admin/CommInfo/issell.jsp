...
<body>
<div align="center">
  <html-el:form action="/admin/CommInfo.do" styleClass="ajaxForm">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableClass">
      ...
      <tr id="up_date_tr">
        ...
        <td  colspan="2" height="24"><fmt:formatDate value="${af.map.up_date}" pattern="yyyy-MM-dd" var="_up_date" />
          <html-el:text property="up_date" styleId="up_date" size="10" maxlength="20" styleClass="webinput" readonly="true" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" style="cursor:pointer;" value="${_up_date}" /></td>
      </tr>
      <tr id="down_date_tr">
		...
		if(Validator.Validate(f, 1)){
			...
			$.jBox.tip("加载中...", "loading");
			 window.setTimeout(function () {
				 $.ajax({
						type: "POST",
						url: "${ctx}/manager/admin/CommInfo.do?method=saveSell",
						data: $(f).serialize(),
						dataType: "json",
