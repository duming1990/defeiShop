...
<div class="divContent">
  ...
  <html-el:form action="/admin/BaseConfig" enctype="multipart/form-data">
    ...
    <html-el:hidden property="method" styleId="method" value="saveLoginPic" />
    <html-el:hidden property="mod_id" styleId="mod_id" />
    <html-el:hidden property="id" styleId="id" />
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableClass">
      <tr>
        <th colspan="3">登录页面图片</th>
      </tr>
      <tr>
      ...
      <td colspan="2">
        ...
        <span style="color:red;">说明：图片大小不能超过2M!建议尺寸【500*384】。</span></td>
    </tr>
    <tr>
      <td nowrap="nowrap" class="title_item">背景颜色代码：</td>
      <td colspan="2">
       <html-el:text property="file_desc" styleId="file_desc" styleClass="webinput" readonly="true"/>
      </td>
    </tr>
      <tr>
