...
<div class="divContent">
  ...
  <html-el:form action="/admin/ServiceInfoAudit" enctype="multipart/form-data">
    <html-el:hidden property="queryString" styleId="queryString" />
    <html-el:hidden property="method" styleId="method" value="saveMTsg" />
    <html-el:hidden property="mod_id" styleId="mod_id" />
    <html-el:hidden property="link_id" styleId="link_id" />
    <html-el:hidden property="id" styleId="id" />
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableClass">
      <tr>
        <th colspan="3">扶贫馆Logo</th>
      </tr>
      <tr>
      ...
      <td colspan="2">
        ...
        <span style="color:red;">说明：图片大小不能超过2M!建议尺寸【160px*200px】</span></td>
    </tr>
      <tr>
