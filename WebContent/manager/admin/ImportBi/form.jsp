...
<div class="mainbox mine">
  ...
  <html-el:form action="/customer/ImoportBi.do"  enctype="multipart/form-data">
...
<!--       </tr> -->
      ...
      <tr>
        ...
        <td colspan="2">
        	  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="backTable" align="left">
                <tr>
                  <th nowrap="nowrap" colspan="5"><b><a class="butbase" onclick="clone();"><span class="icon-configure">添加套餐</span></a></b></th>
                </tr>
                <tr>
...
function setCommInfoToForm(comm_id){
	...
	location.href='${ctx}/manager/customer/CommInfo.do?method=selectCommAddForType4&&comm_id=' + comm_id +"&mod_id="+ mod_id + "&par_id=" + par_id;
}
