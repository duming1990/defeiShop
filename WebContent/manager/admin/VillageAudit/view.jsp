 ...
 <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableClass">
      <tr>
       ...
       <tr>
         ...
         <td><fmt:formatDate value="${af.map.service_operation_date}" pattern="yyyy-MM-dd" />
         -<fmt:formatDate value="${af.map.service_operation_date_end}" pattern="yyyy-MM-dd"/></td>
       </tr>
       <tr>
       ...
       <tr>
	       ...
	       <td colspan="3"><img src="${ctx}/${af.map.village_qrcode_path}" width="100px"/>   
	       </td>
       </tr>
      <tr>
