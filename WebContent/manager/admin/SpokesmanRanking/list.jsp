...
<div class="divContent">
  ...
  <html-el:form action="/admin/SpokesmanRanking" styleClass="searchForm">
     ...
     <table width="100%" border="0" cellpadding="1" cellspacing="1" class="tableClassSearch">
      <tr>
        ...
        <div style="margin-top:5px;" id="city_div">
            ...
            &nbsp;&nbsp;&nbsp;发展会员总数为0的是否显示：
            <html-el:select property="user_num" styleId="user_num">
              <html-el:option value="0">显示</html-el:option>
              <html-el:option value="1">不显示</html-el:option>
            </html-el:select>
            &nbsp;
   ...
   <form id="listForm" name="listForm" method="post">
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableClass">
      <tr class="tite2">
        ...
        <th nowrap="nowrap">发展会员总数</th>
        <th nowrap="nowrap">会员用户名</th>
        <th nowrap="nowrap">代言费</th>
      ...
      <c:forEach var="cur" items="${entityList}" varStatus="vs">
          ...
          <td align="center"><fmt:formatNumber value="${cur.map.sum_money}" pattern="0.00"></fmt:formatNumber></td>
  ...
  <div class="pageClass">
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="SpokesmanRanking.do">
        ...
        <tr>
          <td><script type="text/javascript" src="${ctx}/commons/scripts/pager.js">;</script>
           <script type="text/javascript">
			 ...
			 pager.addHiddenInputs("sum_sale_money","${fn:escapeXml(af.map.sum_money)}");
			 pager.addHiddenInputs("user_num","${fn:escapeXml(af.map.user_num)}");
