  ...
  <html-el:form action="/admin/Activity" enctype="multipart/form-data">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableClass">
      ...
      <tr>
        ...
        <td  colspan="2" height="24" width="85%"><fmt:formatDate value="${af.map.start_date}" pattern="yyyy-MM-dd" var="_start_date" />
          <html-el:text property="start_date" styleId="start_date" size="10" maxlength="20" styleClass="webinput" readonly="true" onclick="WdatePicker();" style="cursor:pointer;" value="${_start_date}" /></td>
      </tr>
      
      <tr>
        <td width="15%" class="title_item" nowrap="nowrap"><span style="color: #F00;">*</span>结束时间：</td>
        <td  colspan="2" height="24" width="85%"><fmt:formatDate value="${af.map.end_date}" pattern="yyyy-MM-dd" var="_end_date" />
          <html-el:text property="end_date" styleId="end_date" size="10" maxlength="20" styleClass="webinput" readonly="true" onclick="WdatePicker();" style="cursor:pointer;" value="${_end_date}" /></td>
      </tr>
      <tr>
