...
<div class="divContent">
  ...
  <html-el:form action="/admin/HBInfoQuery">
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" align="left">
            <tr>
              <td width="19%" nowrap="nowrap">&nbsp;标题：
                ...
                &nbsp;
                &nbsp;是否领完：
                <html-el:select property="is_end">
                  <html-el:option value="">全部</html-el:option>
                  <html-el:option value="0">未领完</html-el:option>
                  <html-el:option value="1">已领完</html-el:option>
                </html-el:select>
                &nbsp;
                &nbsp;红包种类：
  ...
  <form id="listForm" name="listForm" method="post" action="HBInfoQuery.do?method=delete">
    <div style="text-align: left; padding: 5px;">
      ...
      <%--       <input type="button" name="add" id="add" class="bgButton" value="添 加" onclick="location.href='HBInfoQuery.do?method=add&mod_id=${af.map.mod_id}';" /> --%>
    </div>
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableClass">
      <tr>
        ...
        <th width="8%" align="center" nowrap="nowrap">已领取红包量</th>
        <th width="8%" align="center" nowrap="nowrap">是否领完</th>
        <th width="8%" align="center" nowrap="nowrap">是否删除</th>
        <th width="10%" align="center" nowrap="nowrap">操作</th>
      </tr>
      <c:forEach var="cur" items="${rwHbInfoList}">
        <tr>
          ...
          <td align="left"><a title="查看" href="HBInfoQuery.do?method=view&amp;mod_id=${af.map.mod_id}&amp;id=${cur.id}">${fn:escapeXml(cur.title)}</a> </td>
          ...
          <td align="center"><c:if test="${cur.hb_type eq 20}">
              ...
              个 </c:if></td>
          <td align="center"><c:out value="${cur.hb_rec_count}"></c:out>
            个</td>
          <td align="center"><c:choose>
              <c:when test="${cur.is_end eq 0}"> <span style="color: #060;">未领完</span> </c:when>
              <c:when test="${cur.is_end eq 1}"> <span style="color: #F00;">已领完</span> </c:when>
            </c:choose></td>
          <td align="center"><c:choose>
          ...
          <td align="center" nowrap="nowrap">
            ...
            <c:if test="${cur.is_del eq 0}">
             <a class="butbase" onclick="confirmDelete(null, 'HBInfoQuery.do', 'id=${cur.id}&' + $('#bottomPageForm').serialize())"><span class="icon-remove">删除</span></a>
            </c:if>
           </td>
        </tr>
      </c:forEach>
  ...
  <div class="pageClass">
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="HBInfoQuery.do">
      <table width="98%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="10"><script type="text/javascript" src="${ctx}/commons/scripts/pager.js">;</script>
            ...
            pager.addHiddenInputs("is_end", "${af.map.is_end}");
