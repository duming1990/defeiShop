...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="backTable">
    ...
    <tr>
<!--       <td width="15%" class="title_item">退换货订单流水号：</td> -->
<%--       <td width="30%" colspan="2">${fn:escapeXml(af.map.return_no)}</td> --%>
      <td width="15%" class="title_item">用户名：</td>
      <td colspan="3">${fn:escapeXml(af.map.user_name)}</td>
    </tr>
    <tr>
<!--       <td width="15%" class="title_item">商品名称：</td> -->
<%--       <td width="35%" >${fn:escapeXml(af.map.comm_name)}</td> --%>
      <td width="15%" class="title_item">退款金额：</td>
...
<!--     <tr> -->
<!--       <td width="15%" class="title_item">物流公司：</td> -->
<%--       <td colspan="1">${af.map.th_wl_company }</td> --%>
<!--       <td width="15%" class="title_item">物流单号：</td> -->
<%--       <td colspan="1">${af.map.th_wl_no } --%>
      
<%--       <c:if test="${not empty af.map.th_wl_no}"> --%>
<%--               	物流单号：${wlOrderInfo.waybill_no}&nbsp;<br/> --%>
<!--              <button class="bgButton" onclick="kdcx(this)">物流信息查询</button> -->
<%--              </c:if> --%>
<!--       </td> -->
<!--     </tr> -->
<!--     <tr> -->
<!--       <td width="15%" class="title_item">退换货地址：</td> -->
<%--       <td colspan="3">${af.map.return_addr}</td> --%>
<!--     </tr> -->
    <tr>
    ...
    <tr>
      <td colspan="7">
      <table width="100%" border="0"  cellpadding="0" cellspacing="0"  align="left"  class="backTable">
          <tr>
...
<!--     </tr> -->
  ...
  <html-el:form action="/customer/TuiHuoAudit.do" enctype="multipart/form-data">
            ...
            <c:if test="${af.map.is_audit eq 1 }">
              <tr>
              <c:if test="${af.map.audit_state eq 1 or af.map.audit_state eq -1 or af.map.audit_state eq 3}">
                <td class="title_item">平台审核结果：</td>
              ...
              <tr>
                ...
                <td colspan="3"><html-el:text property="remark" styleId="remark" maxlength="125" style="width:480px" styleClass="webinput" /></td>
              </tr>
              </c:if>
              <tr>
              <td colspan="4" align="center">
               <c:if test="${af.map.is_audit eq 1 }">
                <html-el:button property="" value="审 核" styleClass="bgButton" styleId="btn_submit" />
                  ...
                  <html-el:button property="" value="返回" styleClass="bgButton" styleId="btn_back" onclick="history.back();" /></td>
              </tr>
            </table>
          </html-el:form>
