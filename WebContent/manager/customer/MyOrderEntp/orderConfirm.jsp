...
<html-el:form action="/customer/MyOrderEntp.do" styleClass="ajaxForm">
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="backTable">
       <tr>
         <td width="14%" nowrap="nowrap" class="title_item"><span style="color: #F00;">*</span>订单八位密码：</td>
         <td ><html-el:text property="order_password" styleId="order_password" maxlength="16" style="width:200px" styleClass="webinput" /></td>
       </tr>
       <tr>
...
$(document).ready(function(){
	$("#order_password").attr("dataType", "Require").attr("msg", "订单八位密码必须输入");
			...
			$("#btn_submit").attr("value", "正在提交...").attr("disabled", "true");
				$.ajax({
					...
					success: function(data) {
						if(data.ret == "1"){
							$.jBox.tip(data.msg, "success",{timeout:500});
