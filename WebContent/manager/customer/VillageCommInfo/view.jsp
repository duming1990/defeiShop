      ...
      <h3>${naviString}</h3>
       ...
       <table width="100%" border="0" cellpadding="0" cellspacing="0" class="backTable">
        ...
        <tr>
         ...
         <tr>
          <td nowrap="nowrap" class="title_item">图片二维码：</td>
          <td colspan="2">
            <c:if test="${ not empty village_dynamic.qrcode_image_path}">
           <img src="${ctx}/${village_dynamic.qrcode_image_path}@s400x400" height="100"/>
            </c:if></td>
        </tr>
        <tr>
