...
<style >
.areas1 {margin: 5px;position: relative;z-index: 9000;display: inline-block;}
.btns1 {z-index:88888;}
</style>
</head>
<body>
<div class="mainbox mine" style="min-height: 800px">
  <jsp:include page="../_nav.jsp" flush="true"/>
      <html-el:form action="/customer/MyFreight.do">
        ...
        <html-el:hidden property="fromChoose" styleId="fromChoose"/> 
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="backTable" align="left">
         <tr><th colspan="2">模版信息</th></tr>
          <tr>
            <td width="8%" nowrap="nowrap" class="title_item"><span style="color: #F00;">*</span>物流模版名称：</td>
            <td colspan="2" width="92%"><html-el:text property="fre_title" styleId="fre_title" maxlength="30" style="width:280px" styleClass="webinput" /></td>
          </tr>
          <tr>
            <td nowrap="nowrap" class="title_item" ><span style="color: #F00;">*</span>商品地址：</td>
            <html-el:hidden property="cls_id" styleId="cls_id"/>
            <td colspan="2" width="92%"><html-el:select property="province" styleId="province" style="width:120px;" disabled="disabled">
          ...
          <tr>
            <td width="8%" nowrap="nowrap" class="title_item"><span style="color: #F00;">*</span>发货时间：</td>
            <td colspan="2" width="92%"><html-el:select property="delivery_time" styleId="delivery_time">
                <html-el:option value="">请选择...</html-el:option>
          ...
          <tr>
            ...
            <html-el:radio property="is_freeshipping" styleId="is_freeshipping_0" value="0" styleClass="is_freeshipping">
   			<label for="is_freeshipping_0">卖家承担运费</label></html-el:radio>
              &nbsp;&nbsp;&nbsp;&nbsp;
              <html-el:radio property="is_freeshipping" styleId="is_freeshipping_1" value="1" styleClass="is_freeshipping">
              <label for="is_freeshipping_1">买家承担运费</label></html-el:radio></td>
          </tr>
          ...
          <tr>
            ...
            <td colspan="2" width="92%">
            <html-el:radio property="valuation" styleId="valuation_1" value="1">
            <label for="valuation_1">按件数</label></html-el:radio>
              &nbsp;&nbsp;&nbsp;&nbsp;
              <html-el:radio property="valuation" styleId="valuation_2" value="2">
              <label for="valuation_2">按重量</label></html-el:radio>
              </td>
          </tr>
          <tr>
            <td nowrap="nowrap" class="title_item"><span style="color: #F00;">*</span>区域限售：</td>
            <td colspan="2" width="92%">
             <html-el:radio property="area_limit" styleId="area_limit_0" value="0">
             <label for="area_limit_0">不支持</label></html-el:radio>
              &nbsp;&nbsp;&nbsp;&nbsp;
              <html-el:radio property="area_limit" styleId="area_limit_1" value="1">
              <label for="area_limit_1">支持</label></html-el:radio>
          ...
          <c:forEach  var="index" begin="1" end="1" step="1">
            <tr>
              ...
              <td colspan="2" width="92%"><table border="0" cellspacing="0" cellpadding="0" class="backTable" id="dwtable_${index }">
                  <tr>
                    <td colspan ="6"> 默认费用
                  ...
                  <tr id="dw${index}Hidden" style="display: none;">
                    <td  width="30%" align="center"><input type="hidden"   parentSign="${index }"   name="area_pindex_${index}" id="area_pindex_${index}" class="isHaveSon" />
                      <input  readonly name="area_name_${index}" id="area_name_${index}" type="text" class="webinput" maxlength="1900"   style="width:160px" onclick="showArea(this,event)" /></td>
                    <td  width="12%" align="center"><input name="first_weight_${index}" value="0" id="first_weight_${index}" type="text"  style="width:80px" class="webinput" maxlength="9"/></td>
                    <td  width="12%" align="center"><input name="first_price_${index}" id="first_price_${index}"  value="0" type="text" class="webinput" maxlength="9" style="width:80px"/></td>
                    <td  width="12%" align="center"><input name="sed_weight_${index}" id="sed_weight_${index}"  value="0" type="text" class="webinput" maxlength="9"   style="width:80px"/></td>
                    <td  width="12%" align="center"><input name="sed_price_${index}" id="sed_price_${index}"  value="0" type="text" class="webinput" maxlength="9"   style="width:80px"/></td>
                          ...
                          <tbody id="_dw${index}Show">
                            <tr >
                              <td   width="30%" align="center"><input parentSign="${index }"  type="hidden" name="area_pindex_${index}" id="area_pindex_${index}" value ="${area.area_pindex }" class="isHaveSon" />
                                <input  readonly   name="area_name_${index}" id="area_name_${index}" type="text" class="webinput" maxlength="1900"  value="${area.area_name }"  onclick="showArea(this,event)" style="width:160px" /></td>
                              <td  width="12%" align="center"><input name="first_weight_${index}"  id="first_weight_${index}" type="text" value="${area.first_weight }" style="width:80px" class="webinput" maxlength="9"/></td>
                              <td  width="12%" align="center"><input name="first_price_${index}" id="first_price_${index}"  type="text" class="webinput" maxlength="9" value="${area.first_price }"   style="width:80px"/></td>
                              <td  width="12%" align="center"><input name="sed_weight_${index}" id="sed_weight_${index}" type="text" class="webinput" maxlength="9"  value="${area.sed_weight }" style="width:80px"/></td>
                              <td  width="12%" align="center"><input name="sed_price_${index}" id="sed_price_${index}" type="text" class="webinput" maxlength="9"  value="${area.sed_price }"  style="width:80px"/></td>
...
<div  id="areaTopdiv" class="ks-dialog ks-overlay ks-ext-position dialog-areas ks-dialog-shown ks-overlay-shown ks-dialog-focused ks-overlay-focused" style="visibility:visible;left:142px;top:363px;display:none;z-index:999;">
  <input type="hidden" name ="textId" id ="textId" />
  <a href="javascript:void(0)" style="z-index:9" class="ks-ext-close"><span class="ks-ext-close-x"></span></a>
...
$(document).ready(function(){
	...
	**/
	...
	<c:if test="${af.map.valuation eq 1}">
	$("span[id='unit']").each(function(){
		$(this).html("&nbsp;件");
	});	
	</c:if>
	<c:if test="${af.map.valuation eq 2}">
	$("span[id='unit']").each(function(){
		$(this).html("&nbsp;kg");
	});
	</c:if>
...
//单位
    $('input:radio[name=valuation]').click(function(){
    	var v =$(this).val();
		if(v ==1){
			$("span[id='unit']").each(function(){
				$(this).html("&nbsp;件");
	...
	//模版名称
	$("#fre_title").attr("dataType", "Require").attr("msg", "请输入物流模版名称");
	//发货时间
	
	$("#delivery_time").attr("dataType", "Require").attr("msg", "请选择发货时间");
	//是否包邮
	$("input[type=radio][name=is_freeshipping]").eq(0).attr("datatype","Group").attr("msg","请选择是否包邮");  
	//计价方式
	$("input[type=radio][name=valuation]").eq(0).attr("datatype","Group").attr("msg","请选择计价方式");  
	//区域限售
	$("input[type=radio][name=area_limit]").eq(0).attr("datatype","Group").attr("msg","请选择区域限售");  
	
	$("#btn_submit").click(function(){
		
	  var  way1= $("input[name='delivery_way_1']").is(":checked");
	  var way2=  $("input[name='delivery_way_2']").is(":checked");
	  var way3=  $("input[name='delivery_way_3']").is(":checked");
