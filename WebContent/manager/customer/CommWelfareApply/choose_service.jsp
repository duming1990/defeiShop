    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableClass">
      ...
      <c:forEach var="cur" items="${entityList}" varStatus="vs">
        <tr>
          ...
          <c:if test="${not empty cur.map.have}">
          	<td  align="center" style="color: red;">
          	<a class="butbase but-disabled" title="该区域已申请请前往修改界面">
	              	<span class="icon-ok">选择</span>
	              </a>
          	</td>
          </c:if>
           <c:if test="${empty cur.map.have}">
	          <td align="center" nowrap="nowrap">
	              <a class="butbase" id="choose_${cur.id}" onclick="choose(this,'${cur.id}','${cur.p_index}','${cur.servicecenter_name}','${cur.map.full_name}');">
	              	<span class="icon-ok">选择</span>
	              </a>
	          </td>
...
<!--             pager.addHiddenInputs("method", "chooseService"); -->
...
$("#confirm").click(function(){
	W.returnVals(service_ids,service_names,p_indexs,full_names);
	api.close();
})
//]]></script>
</body>
