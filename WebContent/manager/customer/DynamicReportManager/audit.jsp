...
<div class="divContent">
 <jsp:include page="../_nav.jsp" flush="true"/>
  <html-el:form action="/customer/DynamicReportManager.do" enctype="multipart/form-data">
    <html-el:hidden property="queryString" styleId="queryString" />
    <html-el:hidden property="method" styleId="method" value="save" />
    <html-el:hidden property="mod_id" styleId="mod_id" />
    <html-el:hidden property="id" styleId="id" value="${af.map.dynamic_id}"/>
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="backTable">
      ...
      <tr>
        ...
        <td><c:out value="${vDynamic.add_user_name}"/></td>
      </tr>
      <c:if test="${vDynamic.type eq 2 and  not empty vDynamic.comm_name}">
      <tr>
        <td width="14%" class="title_item">商品名称：</td>
        <td><c:out value="${vDynamic.comm_name}"/></td>
      </tr>
      </c:if>
      <tr>
        <td width="14%"  class="title_item">发布内容：</td>
        <td >${fn:escapeXml(vDynamic.content)}</td>
      </tr>
      <tr>
      ...
      <tr>
        <td width="14%"  class="title_item">所属村：</td>
        <td >${fn:escapeXml(vDynamic.village_name)}</td>
      </tr>
      <tr>
        <td width="14%" class="title_item">发布时间：</td>
        <td><fmt:formatDate value="${vDynamic.add_date}" pattern="yyyy-MM-dd"/></td>
      </tr>
       <tr>
        <td width="14%"  class="title_item">举报人：</td>
        <td >${fn:escapeXml(af.map.add_user_name)}</td>
      </tr>
      <tr>
        <td width="14%"  class="title_item">举报缘由：</td>
        <td >${fn:escapeXml(af.map.reason)}</td>
      </tr>
      <tr>
        <th colspan="2">该动态审核信息</th>
      </tr>
      <tr>
        <td class="title_item"><span style="color: #F00;">*</span>审核状态：</td>
        <td >
         <html-el:select property="audit_state" styleId="audit_state" value="${vDynamic.audit_state}">
       ...
       <tr>
        ...
        <td colspan="3">
        <html-el:text property="audit_desc" styleId="audit_desc"  value="${vDynamic.audit_desc}" maxlength="125" style="width:480px" styleClass="webinput" /></td>
      </tr>
      <tr>
