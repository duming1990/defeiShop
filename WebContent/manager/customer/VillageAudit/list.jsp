...
<div class="mainbox mine">
  ...
  <html-el:form action="/customer/VillageAudit">
...
<!--           </a> -->
          ...
          <td align="center" nowrap="nowrap">
            ...
            <logic-el:match name="popedom" value="+8+">
              <div style="padding-top: 2px;">
                <c:if test="${cur.audit_state eq 1}"><a class="butbase" onclick="confirmNeedMethod('您确定取消村驿站吗？', 'VillageAudit.do', 'cancelVillage','id=${cur.id}&mod_id=${af.map.mod_id}&'+$('#bottomPageForm').serialize())"><span class="icon-cancel">取消村驿站</span></a> </c:if>
              </div>
            </logic-el:match>
          </td>
        </tr>
