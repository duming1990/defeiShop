...
<div class="mainbox mine">
  <jsp:include page="../_nav.jsp" flush="true"/>
    <div class="all">
      <c:url var="url" value="/manager/customer/TiXianHuoKuanBi.do?method=list&par_id=1300100000&mod_id=1300300400" />
      <button class="bgButtonFontAwesome" type="button" onclick="location.href='${url}'"><i class="fa fa-history"></i>查看提现历史 </button>
  </div>
  <html-el:form action="/customer/TiXianHuoKuanBi.do" enctype="multipart/form-data">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="backTable">
      ...
      <tr>
        ...
        <td colspan="3"><fmt:formatNumber pattern="#0.########" value="${af.map.bi_huokuan}" var="bi_huokuan" />
          ${bi_huokuan} 元 
          <c:if test="${pre_number ne 0}">
          <span class="label label-info" style="margin-left:5px;">货款提现手续费${pre_number}%</span>
          </c:if>
        </td>
      </tr>
      <tr>
        <td width="14%" nowrap="nowrap" class="title_item">可提现金额：</td>
        <td colspan="3"><fmt:formatNumber pattern="#0.########" value="${huokuan_2_rmb}" var="bi" />
      ...
      <tr>
        ...
        <td colspan="3"><html-el:text property="cash_count" value="0" maxlength="10" styleId="cash_count" style="width:100px"/>
          &nbsp;元<span id="tip" class="label label-danger" style="margin-left: 5px;"></span> </td>
      </tr>
      <tr>
...
$(document).ready(function(){
	...
	$("#cash_count").attr("datatype","Currency").attr("msg","请正确填写提现金额！");
...
$("#cash_count").change(function(){
	...
	var huokuan_2_rmb = parseFloat($("#huokuan_2_rmb").val());
