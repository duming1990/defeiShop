...
<div class="mainbox mine">
  ...
  <html-el:form action="/customer/TiXianHuoKuanBi">
  ...
  <form id="listForm" name="listForm" method="post" action="TiXianHuoKuanBi.do?method=delete">
    <div style="padding:5px;">
      <button class="bgButtonFontAwesome" type="button" onclick="location.href='TiXianHuoKuanBi.do?method=add&&par_id=${af.map.par_id}&mod_id=${af.map.mod_id}';" ><i class="fa fa-plus-square"></i>提现</button>
    </div>
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="backTable">
      ...
      <c:forEach var="cur" items="${entityList}" varStatus="vs">
        <tr>
          ...
          <td align="center"><fmt:formatNumber pattern="#0.00" value="${cur.cash_count}" />
          </td>
          ...
          <td align="center"><c:url var="url" value="/manager/customer/TiXianHuoKuanBi.do?method=view&amp;id=${cur.id}&par_id=${af.map.par_id}&mod_id=${af.map.mod_id}" />
  ...
  <div class="black">
    <form id="bottomPageForm" name="bottomPageForm" method="post" action="TiXianHuoKuanBi.do">
