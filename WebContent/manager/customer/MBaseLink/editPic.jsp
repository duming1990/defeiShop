      ...
      <tr>
        ...
        <div class="files-warp" id="image_path_warp">
          ...
          <div style="color:rgb(241, 42, 34); padding: 5px;"> 
              ...
              <c:if test="${af.map.link_type eq 30}">[图片尺寸] 建议：[750px * 100px] </c:if>
              <c:if test="${af.map.link_type eq 40}">[图片尺寸] 建议：[810px * 240px] </c:if>
              <c:if test="${af.map.link_type eq 100}">[图片尺寸] 建议：[465px * 243px] </c:if>
              <c:if test="${af.map.link_type eq 600}">[图片尺寸] 建议：[465px * 243px] </c:if>
