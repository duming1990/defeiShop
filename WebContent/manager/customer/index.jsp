...
<script type="text/javascript" src="${ctx}/commons/scripts/public_customer.js"></script>
...
<body style="background-color:#017cbc;">
<div class="admincp-header">
  ...
  <div class="admincp-header-r">
    ...
    <ul class="operate nc-row">
      ...
      <li><a class="login-out show-option" onclick="loginOut();" href="javascript:void(0);" title="安全退出管理中心">&nbsp;</a></li>
    </ul>
  </div>
  <div class="clear"></div>
</div>
