...
<div align="center" style="height:auto;overflow:auto;">
    <fieldset style="height:190px">
        ...
        <div id="chZj" style="height:108px;overflow:auto;">
    ...
    <div>
        <html-el:form action="/customer/OfflinePayment.do">
    ...
    <div class="clear"></div>
    <div class="pageClass">
        <form id="bottomPageForm" name="bottomPageForm" method="post" action="OfflinePayment.do">
