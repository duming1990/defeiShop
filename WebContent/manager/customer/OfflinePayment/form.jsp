...
<div class="divContent">
    ...
    <html-el:form action="/customer/OfflinePayment" >
...
<%--                     <fmt:formatDate value="${beginDate}" pattern="yyyy-MM-dd" var="_beginDate" /> --%>
                    <html-el:text property="beginDate" styleId="beginDate" size="20" maxlength="10" readonly="true" styleClass="webinput" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
                </td>
            </tr>
<!--             <tr> -->
...
function getdiscount_comm_names(){
    ...
    var url = "OfflinePayment.do?method=listCommInfo&discount_comm_ids="+discount_comm_ids;
    $.dialog({
        title:  "选择商品",
        width:  1200,
        height:700,
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            for (var i = 0; i < entityList.length; i++) {
                ...
                html+='<td><input maxlength="8" style="width:100px" styleClass="webinput" name="this_comm_price" id="priceTd_'+entityList[i].id+'" onchange="getSum()" datatype="Double" msg="请填写商品单价！" value="'+price_ref+'"/></td>';
                html+='</tr>';
            }
            html+='</tbody>';
