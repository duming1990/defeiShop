...
<div class="divContent">
  ...
  <html-el:form action="/customer/Activity" styleClass="searchForm">
...
$(document).ready(function(){
	 $("#download").click(function(){
			var submit = function (v, h, f) {
			    if (v == true) {
			    	location.href = "${ctx}/manager/customer/Activity.do?method=toExcel&mod_id=${af.map.mod_id}&" + $('.searchForm').serialize();
			    } else {
			    	location.href = "${ctx}/manager/customer/Activity.do?method=toExcel&code=GBK&mod_id=${af.map.mod_id}&" + $('.searchForm').serialize();
			    }
			    return true;
			};
...
function openEntpChild(){
	...
	var url = "${ctx}/BaseCsAjax.do?method=chooseEntpInfo&dir=customer";
	$.dialog({
		title:  "选择企业",
		width:  770,
		height: 550,
