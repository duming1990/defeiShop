...
<div align="center" style="height:550px;overflow:auto;">
    <fieldset>
        ...
        <div id="chZj" style="height:45px;overflow:auto;">
            <ul id="fdul" class="fdul">
                <c:forEach items="${entityList}" var="cus">
                <c:if test="${not empty cus.map.comm_info}">
                    <li><a href="javascript:void(0);" id="a_${cus.map.comm_info.id}">${cus.map.comm_info.comm_name}</a></li>
                </c:if>
                </c:forEach>
            </ul>
        </div>
    ...
    <div>
        <html-el:form action="/customer/Coupons.do">
