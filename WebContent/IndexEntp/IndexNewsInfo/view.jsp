...
<body>
    ...
    <div class="wrap showWrap">
        ...
        <div class="hxywjs_position">
          <img src="${ctx}/styles/indexEntp/images/show_pos.png" alt="icon" /><a href="${ctx }/indexEntp/IndexEntp.do">首页</a>>>  <span>${mod_name}</span>
        </div>
        <div class="show_txt">
          <h3 class="show_txt_t">${entity.title }</h3>
          
          <div class="show_txt_d">发布日期：<fmt:formatDate value="${entity.add_time}" pattern="yyyy-MM-dd" /></div>
